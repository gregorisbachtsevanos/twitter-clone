    ...
    for (let post of data.posts) {
        load = /*html*/ `
            <div class="card card-container m-3 w-100" data-id="${post._id}">
                ...
                : /*html*/ `
                                <li><a class="dropdown-item" id="repost" href="${APP_URL}repost/${post._id
                }">Re-post</a></li>
                                <li><a class="dropdown-item" id="${post.isSaved ? "unsave-post" : "save-post"
                }" href="#">${post.isSaved ? "Unsave" : "Save"
                }</a></li>`
            }
                        </ul>
                    </div>
